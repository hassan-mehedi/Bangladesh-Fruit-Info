...
public class SearchFruitDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_fruit_detail);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        fruitNameText = findViewById(R.id.finalTextViewId);
        infoText = findViewById(R.id.infoFinalTextId);
        fruitImage = findViewById(R.id.finalImageViewId);

        SharedPreferences sharedPreferences = getSharedPreferences("fruit_access",MODE_PRIVATE);
        String fruit_name = sharedPreferences.getString("fruit_name","No fruit name found");
        showPage(fruit_name);
    }
